...
func (u *User) CheckUsernameExists(ctx context.Context, db *sql.DB, username string) (bool, error) {
...
func (u *User) CheckEmailExists(ctx context.Context, db *sql.DB, email string) (bool, error) {
